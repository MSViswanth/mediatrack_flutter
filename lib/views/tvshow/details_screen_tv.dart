                            ...
                            Row(
                              ...
                              children: <Widget>[
                                widget.tvshow.firstAirDate != ''
                                    ? Text(
                                  '${DateTime.parse(widget.tvshow.firstAirDate).year}'+'  -  '+'${widget.tvshow.status=='Ended'? DateTime.parse(widget.tvshow.lastEpisodeToAir.airDate).year: 'Present'}',
...
//                              .certification),
                  ...
                  widget.tvshow.homepage != null &&
                      widget.tvshow.homepage != ''
                      ? Container(
                  ...
                  Container(
                    ...
                    child: widget.tvshow.originCountry == null
                      ...
                      itemCount:
                      widget.tvshow.originCountry.length,
                    )
                        : Center(
